...
```
https://sportsindex.app/portfolio/your-username
```

<Callout type="tip">
  Check out a live example at [sportsindex.app/portfolio/ben](https://sportsindex.app/portfolio/ben) to see what a portfolio looks like in action.
</Callout>
